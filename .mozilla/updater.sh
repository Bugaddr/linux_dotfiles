...
update_updater() {
  ...
  declare -r tmpfile="$(download_file 'https://rawgithubusercontent.deno.dev/arkenfox/user.js/master/updater.sh')"
...
update_userjs() {
  declare -r newfile="$(download_file 'https://rawgithubusercontent.deno.dev/arkenfox/user.js/master/user.js')"
    ...
    while getopts ":hp:ludsno:bcvre" opt; do
      case $opt in
        ...
        e)
          ...
          ;;
        r)
          tfile="$(download_file 'https://rawgithubusercontent.deno.dev/arkenfox/user.js/master/user.js')"
